# Token Plan (MiMo — mimo.mi.com)

**Token Plan** is a dedicated subscription plan launched for AI programming scenarios.
...
- **Discounts**: 0.8x consumption at night, first purchase of a package enjoys 12% discount, consecutive annual subscription enjoys 12% discount.
...
Language models deduct Credit quota based on the number of Tokens.
